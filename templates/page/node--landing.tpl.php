...
<?php else: ?>
  ...
  ?>
  <section class="usa-hero" <?php if ($herobackgrnd):?> style="background-image: url('<?php print $herobackgrnd; ?>')"<?php endif;?>>
    <div class="usa-grid">
  ...
  <section class="usa-section usa-section-dark usa-graphic_list">
    <?php print render($content['field_graphic_list']); ?>
  </section>
  ...
  <?php
  if (!empty($herobackgrnd)): hide($content['field_image']); endif;
